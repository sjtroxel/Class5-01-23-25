        ...
        // ****In-Class Exercises (Thursday, 01/23/2025)****
...
// ----
        ...
        2
// const student = {
//         name: 'Strawberry The Cat',
//         age: 3.5,
//         grades: [110, 98, 102, 104, 96],
// }
            
// const sumGrades = student.grades.reduce( (acc,e ) => acc + e , 0)   

// console.log(sumGrades);   
// console.log(student.grades.length);

// const gradeAverage = (sumGrades / student.grades.length);

// console.log(gradeAverage)

// console.log(`${student.name}'s average grade is ${gradeAverage}!`);
...
const list = document.getElementById('my-ordered-list');
